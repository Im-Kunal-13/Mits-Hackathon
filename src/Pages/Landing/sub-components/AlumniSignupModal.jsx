...
export default function AlumniSignupModal() {
  return (
    <div
      className="modal fade"
      id="signup-alumni-backdrop"
        ...
        <div className="modal-content rounded-3xl border-0 px-20">
          ...
          <div className="modal-body">
            ...
            {/* <div className="input-group mb-3">
              <span
                className="input-group-text bg-white border-r-0 rounded-lg border-0 shadow"
                id="basic-addon1"
              >
                <i className="bi bi-telephone-fill text-2xl text-themeViolet1"></i>
              </span>
              <input
                type="number"
                className="form-control border-l-0 rounded-lg border-0 shadow"
